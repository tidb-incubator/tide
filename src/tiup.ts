...
class TiUPImpl implements TiUP {
    constructor(host: Host, fs: FS, shell: Shell, pathfinder: (() => Promise<string>) | undefined) {
        this.context = {
            host: host,
            fs: fs,
            shell: shell,
...
export function create(versioning: TiUPVersioning, host: Host, fs: FS, shell: Shell): TiUP {
